# -*- coding: utf-8 -*-
# Copyright (C) 2006-2025 Christian Tanzer. All rights reserved
...
#     2-Nov-2024 (CT)  Add `memoized`
#    17-Dec-2024 (CT)  Add `Simpleton`
#    ««revision-date»»···
#--
...
def Simpleton (c) :
    """Instantiate the decorated class: a Simple Singleton.

    Normally, i.e., in the absence of `__new__` or metaclass trickery,
    that puts a single instance of the class in the surrounding namespace
...
def eval_function_body (f) :
    ...
    Instead of the function itself, the result of the call is returned!

    This allows use of local variables for complex initializations to avoid
    polluting the calling scope's namespace.
    """
    return f ()
...
@Decorator
def memoized (f) :
    """Add memoization to function `f`.

    >>> @memoized
    ... def square (x) :
    ...     print ("square called with", end = " ")
    ...     return x * x
    ...
    ...     print ("2. call", end = " ")
    ...     print (square (x))
    1. call square called with 1
    2. call 1
    1. call square called with 4
    2. call 4
    1. call square called with 9
    2. call 9
    """
    cache = {}
    def _ (* args) :
