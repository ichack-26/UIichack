...
#    22-Aug-2025 (CT) Use raw strings for regexp (Py3.14 compatibility)
#                     * Need to use raw string for docstring
#                       containing a raw string with a regexp, duh!
#    ««revision-date»»···
#--
...
class By_Regexp (_Recordifier_) :
    r"""Convert strings via regexp to records.
