# -*- coding: utf-8 -*-
# Copyright (C) 2011-2025 Christian Tanzer All rights reserved
...
#    16-Feb-2025 (CT) Factor `Node.get_child`
#                     + Correct `gen` call in `Node.pre_order`
#    ««revision-date»»···
#--
...
class Node (object, metaclass = TFL.Meta.M_Autosuper) :
    ...
    def get_child (self, key) :
        ...
        try :
            ...
            result  = children [key] = self.__class__ (self)
        return result
    # end def get_child
