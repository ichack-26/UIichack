...
#    15-Aug-2024 (CT) Add `Compass_Rose.average`
#    ««revision-date»»···
#--

from   _TFL                       import TFL

from   _TFL.Angle                 import Angle_D, average_angle
...
class Compass_Rose (TFL.Meta.Object, metaclass = M_Compass_Rose) :
    ...
    def average (self, directions, weights = None) :
        return self.Direction (average_angle (directions, weights))
    # end def average
